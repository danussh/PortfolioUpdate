                ...
                <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
                    <VerticalTimeline>
                        ...
                        >
                            ...
                            <p>
                            In part of Document processing team in athenahealthfor developing a Data Capturing Tool.This tool will Capture data present on the image usingthe rectangular selector that's drawn over the image. Auto-populate  captured/selected data retrieved from 
                            </p>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                        ...
                        >
                            ...
                            <p>
                                Worked as a  Full-Stack developer For CRM Tool,aProduct of DealerSocketConverted a Existing CRM tool built is ASP.Net ToReact Js
                            </p>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                            className="vertical-timeline-element--education"
